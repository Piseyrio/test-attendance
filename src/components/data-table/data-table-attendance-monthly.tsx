...
export function DataTableAttendanceMonthly<TData, TValue>({
  columns,
  data,
  ...
  const table = useReactTable({
    ...
    autoResetPageIndex: false, // ✅ don't jump back to page 1 on edits/filters
  });
